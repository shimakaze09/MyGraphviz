...
Graphviz::Subgraph& Graphviz::Subgraph::DeregisterGraphAttr(
    const std::string& key) {
  graphAttrs.erase(key);
  return *this;
}

Graphviz::Subgraph& Graphviz::Subgraph::DeregisterGraphNodeAttr(
    const std::string& key) {
  graphNodeAttrs.erase(key);
  return *this;
}

Graphviz::Subgraph& Graphviz::Subgraph::DeregisterGraphEdgeAttr(
    const std::string& key) {
