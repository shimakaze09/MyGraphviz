...
class Registry {
 public:
  ...
  using ElemAttrMap =
      std::map<size_t, std::map<std::string, std::string, std::less<>>>;
  ...
  Registry& RegisterNodeAttr(size_t nodeIndex, std::string key,
                             std::string value);
  Registry& RegisterEdgeAttr(size_t edgeIndex, std::string key,
                             std::string value);
