...
int main() {
  ...
  c0.RegisterGraphNodeAttr("style", "filled")
  ...
  c1.RegisterGraphNodeAttr("style", "filled")
  ...
  registry.RegisterNodeAttr(v_start, "shape", "Mdiamond")
