...
Graphviz::Subgraph& Graphviz::Subgraph::AddGraphAttr(std::string key,
                                                     std::string value) {
  graphAttrs.emplace_back(std::move(key), std::move(value));
  return *this;
}

Graphviz::Subgraph& Graphviz::Subgraph::AddAllNodeAttr(std::string key,
                                                       std::string value) {
  allNodeAttrs.emplace_back(std::move(key), std::move(value));
  return *this;
}

Graphviz::Subgraph& Graphviz::Subgraph::AddAllEdgeAttr(std::string key,
                                                       std::string value) {
...
Graphviz::Subgraph& Graphviz::Subgraph::AddEdge(std::string lhs,
                                                std::string rhs) {
  auto edgeID = lhs + rhs;
...
Graphviz::Subgraph& Graphviz::Subgraph::AddNodeAttr(const std::string& nodeID,
                                                    std::string key,
                                                    std::string value) {
...
Graphviz::Subgraph& Graphviz::Subgraph::AddEdgeAttr(const std::string& lhs,
...
Graphviz::Graph& Graphviz::Graph::AddGraphAttr(std::string key,
                                               std::string value) {
  return static_cast<Graph&>(
      Subgraph::AddGraphAttr(std::move(key), std::move(value)));
}

Graphviz::Graph& Graphviz::Graph::AddAllNodeAttr(std::string key,
                                                 std::string value) {
  return static_cast<Graph&>(
      Subgraph::AddAllNodeAttr(std::move(key), std::move(value)));
}

Graphviz::Graph& Graphviz::Graph::AddAllEdgeAttr(std::string key,
                                                 std::string value) {
  return static_cast<Graph&>(
      Subgraph::AddAllEdgeAttr(std::move(key), std::move(value)));
}
...
Graphviz::Graph& Graphviz::Graph::AddNodeAttr(const std::string& nodeID,
                                              std::string key,
                                              std::string value) {
  return static_cast<Graph&>(
      Subgraph::AddNodeAttr(nodeID, std::move(key), std::move(value)));
}

Graphviz::Graph& Graphviz::Graph::AddEdgeAttr(const std::string& lhs,
                                              const std::string& rhs,
                                              std::string key,
                                              std::string value) {
  return static_cast<Graph&>(
      Subgraph::AddEdgeAttr(lhs, rhs, std::move(key), std::move(value)));
}
