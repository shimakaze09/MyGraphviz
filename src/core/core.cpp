...
Graphviz::SubGraph& Graphviz::SubGraph::AddNodeAttr(size_t nodeIdx,
                                                    std::string key,
                                                    std::string value) {
...
Graphviz::SubGraph& Graphviz::SubGraph::AddEdgeAttr(size_t edgeIdx,
                                                    std::string key,
                                                    std::string value) {
...
size_t Graphviz::SubGraph::AddSubGraph(SubGraph subgraph) {
...
Graphviz::Graph& Graphviz::Graph::AddNodeAttr(size_t nodeIdx, std::string key,
                                              std::string value) {
  return static_cast<Graph&>(
      SubGraph::AddNodeAttr(nodeIdx, std::move(key), std::move(value)));
}

Graphviz::Graph& Graphviz::Graph::AddEdgeAttr(size_t edgeIdx, std::string key,
                                              std::string value) {
  return static_cast<Graph&>(
      SubGraph::AddEdgeAttr(edgeIdx, std::move(key), std::move(value)));
}
